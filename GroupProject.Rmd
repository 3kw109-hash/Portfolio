...
```{r interactive-scatterplot-matrix, echo=FALSE, out.width="70%", out.height="70%", fig.align="center", fig.valign="top"}
knitr::include_graphics("Pimg/PW.png")

```



```{r interactive-scatterplot-matrix, echo=FALSE, out.width="80%", out.height="80%"}
library(psych)
...
need output here to show the new groups. 
...
<br>
<br>
- Helps find variables that are not statistically significant
]
```{r interactive-logistic-regression-summary, fig.cap="Summary of inferential statistics of the full model", out.width="100%"}
...
```{r interactive-reduced-model-summary, fig.cap="Summary of inferential statistics of the reduced model", out.width="100%"}
# Load necessary libraries
library(knitr)
library(kableExtra)
library(DT)
...
```{r interactive-final-model-summary, fig.cap="Summary of inferential statistics of the final model", out.width="40%", fig.height=2}
# Load necessary libraries
library(knitr)
library(kableExtra)
library(DT)
...
<br>
<br>
```{r interactive-goodness-of-fit, fig.cap="Comparison of global goodness-of-fit statistics", out.width="50%", fig.height=4}
# Load necessary libraries
library(knitr)
library(kableExtra)
library(DT)
...
```{r interactive-odds-ratio, fig.cap="Summary Stats with Odds Ratios", out.width="50%", fig.height=4}
# Load necessary libraries
library(knitr)
library(kableExtra)
library(DT)
